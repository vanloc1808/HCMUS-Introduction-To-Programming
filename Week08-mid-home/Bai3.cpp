...
int sumOfBorders(double a[100][100], int row, int column)
{
    int sum;
    sum = 0;
    for (int j = 0; j < column; j++)
...
int sumRowK(double a[100][100],int row, int column, int k)
{
    double sumRowK = 0;
    for (int j = 0; j < column; j++)
    {
...
int main()
{
    ...
    system("pause");
    cout << "Tong cac so tren duong bien la: " << sumOfBorders(a, row, column);
}
